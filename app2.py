...
API_KEY = "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"
...
def limpiar_csv_crudo(csv_crudo, columnas_esperadas=6):
    ...
    for fila in reader:
        ...
        # Ya no reemplazamos precondiciones vacías por "Ninguna" para forzar que siempre existan
        # Por seguridad, si está vacía, poner aviso para revisión manual:
        if fila[1].strip() == "":
    ...
    if not texto_para_generar.strip():
        ...
        with st.spinner("Generando casos de prueba..."):
            ...
            if resultado:
                ...
                st.dataframe(pd.read_csv(io.StringIO(csv_limpio)))
